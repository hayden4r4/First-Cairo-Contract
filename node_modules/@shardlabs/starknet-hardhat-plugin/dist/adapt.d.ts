 ...
 */
export declare function adaptInput(functionName: string, input: any, inputSpecs: starknet.Argument[], abi: starknet.Abi): string[];
/**
 ...
 */
export declare function adaptOutput(rawResult: string, outputSpecs: starknet.Argument[], abi: starknet.Abi): StringMap;
